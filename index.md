...
<div class="btn-container site-container">
  <a href="https://m97493578-ops.github.io/PocketPython/">🐍 PocketPython Website</a>
</div>

* Features individual zero-install packages tailored exclusively for running scripts inside school and workspace drives.

## 📦 Available Package

<div class="btn-container">
  <a href="https://github.com/m97493578-ops/PocketPyCharm/releases">📦 Download Standard Archive (ZIP)</a>
</div>
...
1. Download the latest `PocketPyCharm.zip` version package using our button below:
<div class="btn-container site-container">
  <a href="https://github.com/m97493578-ops/PocketPyCharm/releases">🚀 Open Releases Page</a>
</div>
